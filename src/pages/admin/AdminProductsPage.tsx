    ...
    <div className="p-4 pb-8 space-y-4 max-w-6xl mx-auto">
      ...
      {isLoading ? (
        <div className="space-y-3">
          {[...Array(5)].map((_, i) => (
            <div key={i} className="card p-3.5 flex gap-3.5 items-center border border-gray-100 shadow-sm bg-white animate-pulse">
      ...
      {hasNextPage && (
        <button onClick={() => fetchNextPage()} className="btn-secondary w-full py-3 mt-4">
          Load More
        </button>
      )}
    </div>
